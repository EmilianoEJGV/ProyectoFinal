...
<div class="container mt-4">
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                <th scope="col" class="text-center">ID del aviso</th>
                <th scope="col" class="text-center">Mensaje de aviso</th>
                  <th scope="col">Status de la tarea</th>
                  <th scope="col" class="text-center">Horario de limpieza</th>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="deleteMAN.php?id=<?= $row[0]?>" class="btn btn-danger">Eliminar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
