...
<div class="container mt-4">
    ...
    <div class="pb-3">
        <a href="indexPR.php" class="btn btn-primary"><i class="fa-solid fa-arrow-left fa-beat"></i> Regresar</a>
        <a href="editPR.php?id=<?=$date[0]?>" class="btn btn-success">Actualizar</a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="deletePR.php?id=<?=$date[0]?>" class="btn btn-danger">Eliminar</a>
                    </div>
                </div>
            </div>
        </div>
